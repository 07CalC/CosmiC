...
interface User {
    ...
    username: string;
    email: string;
    role: 'owner' | 'admin' | 'user';  // Update the type to be more specific
    is_admin: boolean;
}
...
export const UsersPage = () => {
    ...
    console.log(user)
    const handleCreateUser = async (userData: { username: string; email: string; password: string; is_admin: boolean }) => {
        try {
            ...
            <div className="flex justify-between items-center mb-6">
                ...
                <div className="flex items-center gap-4">
                    <button
                        ...
                        className="px-4 py-2 disabled:cursor-not-allowed bg-[#1F6FEB] cursor-pointer text-white rounded-lg hover:bg-[#1A73E8] transition-colors"
